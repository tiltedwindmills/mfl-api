...
public interface MflLeagueExport {
	 ...
	 * Gets the league.
	 *
	 * {@code http://football.myfantasyleague.com/2013/export?TYPE=league&JSON=0&L=10779&FRANCHISE=0001&PASSWORD=foobar }
	 *
	 * @param league the league
	 ...
	 *
	 * {@code http://football3.myfantasyleague.com/2013/export?TYPE=liveScoring&L=10779&W=3&JSON=0 }
	 *
	 * @param league the league
	 * @param week the week
	 * @param year the year
	 ...
	 *
	 * {@code http://football3.myfantasyleague.com/2015/export?TYPE=weeklyResults&L=20428&W=4&JSON=1 }
	 *
	 * @param league the league
	 * @param week the week
	 * @param year the year
	 ...
	 */
	@GET("/{year}/export?TYPE=weeklyResults&JSON=1")
	WeeklyResultsResponse getWeeklyResults(@Query("L") int league, @Query("W") int week, @Path("year") int year);
